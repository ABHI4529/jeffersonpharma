        ...
        <div className={"flex flex-col px-[4%] md:px-[8%] py-[8%] min-h-screen gap-20"}>
            <div className={"flex flex-col-reverse md:flex-row justify-between items-center gap-8"}>
                <div className={"flex flex-col w-full md:w-1/2"}>
                    ...
                    <p className={"text-sm md:text-md text-muted-foreground"}>With over two decades of experience as a leading
                ...
                <div className={"flex justify-end w-full md:w-1/2 h-auto"}>
            ...
            <div className={"flex flex-col md:flex-row justify-between items-center gap-8"}>
                <div className={"flex w-full md:w-1/2 h-auto"}>
                    <img src={home_coin.src} alt={"home deliver"} className={"w-[80%] md:w-[50%] object-contain"}/>
                </div>
                <div className={"flex flex-col w-full md:w-1/2"}>
                    <h1 className={"text-xl md:text-2xl font-bold"}>Validated Cold Chain Shipment</h1>
                    <p className={"text-sm md:text-md text-muted-foreground"}>With over two decades of experience as a leading
            ...
            <div className={"flex flex-col-reverse md:flex-row justify-between items-center gap-8"}>
                <div className={"flex flex-col w-full md:w-1/2"}>
                    <h1 className={"text-xl md:text-2xl font-bold"}>Pharmaceutical Contract</h1>
                    <p className={"text-sm md:text-md text-muted-foreground"}>GNH Provides Contract Manufacturing services for: Generic
