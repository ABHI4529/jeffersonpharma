        ...
        <div className={"flex flex-col px-[4%] py-[8%] min-h-screen gap-20"}>
            <div className={"flex justify-between items-center gap-8"}>
                <div className={"flex flex-col w-1/2"}>
                    <h1 className={"text-2xl font-bold"}>Services That We Deliver</h1>
                    <p className={"text-muted-foreground"}>With over two decades of experience as a leading
                ...
                <div className={"flex justify-end w-1-2 h-auto"}>
                    <img src={home_deliver.src} alt={"home deliver"} className={"w-[80%] object-contain"}/>
                </div>
            </div>
            <div className={"flex justify-between items-center gap-8"}>
                <div className={"flex w-1-2 h-auto"}>
                    <img src={home_coin.src} alt={"home deliver"} className={"w-[50%] object-contain"}/>
                </div>
                <div className={"flex flex-col w-1/2"}>
                    <h1 className={"text-2xl font-bold"}>Validated Cold Chain Shipment</h1>
                    <p className={"text-muted-foreground"}>With over two decades of experience as a leading
                        ...
                        manufactured transported and stored at very</p>
                </div>
            </div>
            <div className={"flex justify-between items-center gap-8"}>
                <div className={"flex flex-col w-1/2"}>
                    <h1 className={"text-2xl font-bold"}>Pharmaceutical Contract</h1>
                    <p className={"text-muted-foreground"}>GNH Provides Contract Manufacturing services for: Generic
                        ...
                        serves as a business</p>
                </div>
                <div className={"flex justify-end w-1-2 h-auto"}>
                    <img src={home_contract.src} alt={"home deliver"} className={"w-[80%] object-contain"}/>
                </div>
            </div>
        </div>
    )
