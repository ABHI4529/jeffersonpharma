...
export default function HeroSection() {
    ...
    return (
        <div className="relative items-center justify-center w-full h-screen overflow-hidden">
           <HomeHeroCarousel/>
            <div className={"absolute px-[4%] flex w-[55%] h-full justify-center flex-col gap-1"}>
                <h1 className={`text-3xl ${bebasNeue.className}`}>JEFFERSON IMPLEX PVT. LTD.</h1>
                <h1 className={"text-4xl font-bold"}>
                    Empowering Global Healthcare with World-Class Pharmaceuticals
                </h1>
                <h2 className={"text-md text-muted-foreground w-[90%]"}>
